...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.5]{Figures/geneGainLossComplete.pdf}
...
%\centering
%\caption{One-step}
\includegraphics[scale=0.5]{Figures/whichfirstComplete.pdf}
%\end{subfigure}\hfill%
%\begin{subfigure}{0.48\textwidth}
%\centering
%\caption{Two-step}
...
\hrule
\vspace{1ex}
\includegraphics[scale=0.5]{Figures/pLossComplete.pdf}
