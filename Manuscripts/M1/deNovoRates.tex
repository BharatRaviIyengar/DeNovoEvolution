...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.5]{\figdir/pGainLossFix2.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.5]{\figdir/whoisfirstX.pdf}
...
\hrule
\vspace{1ex}
\includegraphics[scale=0.5]{\figdir/pLoss_promoterlessX.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.5]{\figdir/proteinComposition.pdf}
...
We thank Pete Czuppon (IEB, University of M\"{u}nster), for discussions on mathematical models.
