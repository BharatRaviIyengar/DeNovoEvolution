...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.6]{Figures/geneGainLossComplete.pdf}
...
%\centering
%\caption{One-step}
\includegraphics[scale=0.6]{Figures/whichfirstComplete.pdf}
%\end{subfigure}\hfill%
%\begin{subfigure}{0.48\textwidth}
%\centering
%\caption{Two-step}
...
\hrule
\vspace{1ex}
\includegraphics[scale=0.6]{Figures/pLossComplete.pdf}
